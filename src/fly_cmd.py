...
pub_land_drone_one = rospy.Publisher("/drone1/tello/land", EmptyMsg, queue_size=1)
pub_land_drone_two = rospy.Publisher("/drone2/tello/land", EmptyMsg, queue_size=1)
...
def cmd():
    ...
    while not rospy.is_shutdown():
        ...
        if command == 108:
            pub_land_drone_one.publish()
            pub_land_drone_two.publish()
        # print("QQQ\n")
